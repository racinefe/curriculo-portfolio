  ...
  public arrayProjects = signal<IProjects[]>([
    {
      ...
      with: '120px',
      height:'91px',
      description: `<p>Projeto Full Stack de matrícula, utilizando o Firebase como banco de dados para armazenamento,
    ...
    },
    {
      ...
      with: '120px',
      height:'91px',
      description: `<p>Projeto web, onde criei um to-do list, o projeto possui todas as funcionalidades do GRUD (create, read, update e delete),
    ...
    },
    {
      ...
      description: `<p>Projeto web, onde criei um Pokédex interativo sendo possível pesquisar através do nome de um Pokémon ou do ID.
    ...
    },
    {
      ...
      description: `<p>Projeto web, onde criei um Gerador de QR code interativo, sendo possível ao usuário digitar um link e a aplicação gera  um QR code correspondente na tela,
